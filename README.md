...
фильтр пользователя (в первую очередь по цене), **мгновенно присылает уведомление
в Telegram**.
...
`/start`, задаёт свою максимальную цену и получает **свои** уведомления.
Площадки опрашиваются один раз на всех; у каждого подписчика свой фильтр,
пауза и персональная история показанных лотов (дедуп на пользователя).
